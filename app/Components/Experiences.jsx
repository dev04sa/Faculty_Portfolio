    ...
    <div className=" my-10  min-w-min mx-5 flex flex-col gap-7     ">
      ...
      <div className=" bg-slate-50 py-5 px-5  shadow-lg ">
        ...
        <ul className=" mx-10 list-disc text-[1.1rem] ">
          ...
          <li>
            Assistant Professor National Institute of Technology Sikkim [ 28th
            December 2015 | 26th October 2022 ]
          </li>
          <li>
            Assistant Professor (Adhoc) National Institute of Technology Sikkim
            [ 18th Feb 2014 | 27th December 2015 ]
          </li>
          <li>
            Assistant Professor SR International Institute of Technology,
            Hyderabad [ 18th July 2013 | 15th Feb 2014 ]
          </li>
        </ul>
      </div>
    </div>
